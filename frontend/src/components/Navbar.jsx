        ...
        <div>
            {
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                    ...
                    <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Krishna {user.name}</p>
                ...
                <div className='flex items-center gap-2 sm:gap-5'>
                    ...
                    <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 text-white px-7 py-2 rounded-full sm:px-10 '>Login</button>
                </div>
            }
        </div>
    </div>
